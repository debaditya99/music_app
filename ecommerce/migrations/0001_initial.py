# Generated by Django 3.2 on 2021-06-07 08:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('IN', 'India'), ('NP', 'Nepal')], default='IN', max_length=2)),
                ('state', models.CharField(choices=[('DL', 'Delhi'), ('HR', 'Haryana'), ('PB', 'Punjab'), ('UP', 'Uttar Pradesh'), ('LK', 'Lucknow'), ('BH', 'Bihar'), ('BN', 'Bangalore'), ('MH', 'Maharastra')], default='DL', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('G', 'Guitar'), ('V', 'Voilin'), ('P', 'Piano'), ('T', 'Tabla'), ('D', 'Drum')], default='S', max_length=2)),
